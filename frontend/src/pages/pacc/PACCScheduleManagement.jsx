...
const PACCScheduleManagement = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const schedulesResponse = await paccAPI.schedules.getAll();
      setSchedules(schedulesResponse);

      // Cargar alertas
      const alertsResponse = await paccAPI.alerts.getAll();
      setAlerts(alertsResponse);

      // Cargar evaluación de cumplimiento más reciente
      const complianceResponse = await paccAPI.compliance.getLatest();
      ...
      setProcurementProcesses(processesResponse);
